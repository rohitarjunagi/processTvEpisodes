...
[![Build Status](https://travis-ci.org/rohitarjunagi/processTvEpisodes.svg?branch=master)](https://travis-ci.org/rohitarjunagi/processTvEpisodes)
...
- The Episodes Data needs to be in application/json format
...
```
- If episode count is 0 or less than 0, the episode does not get included in the response
- If the data is not of type application/json, you will get an error
- If the post data is empty, you will get an error
- If the post data does not cuntain "payload" element, you will get an error
- If the "payload" element does not contain any data, you will get an error
